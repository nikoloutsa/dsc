...
#SBATCH --output=logs/horovod_pytorch_cifar10_resnet.N1.G2.B32.%j.out 
#SBATCH --error=logs/horovod_pytorch_cifar10_resnet.N1.G2.B32.%j.err 
#SBATCH --ntasks=2
#SBATCH --gres=gpu:2
#SBATCH --nodes=1 
...
srun -l python -u train.horovod.pytorch.cifar10.py --config=configs/pytorch_cifar10_resnet.B32.yaml 
