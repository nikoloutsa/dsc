...
#SBATCH --output=logs/tensorflow_cifar10_resnet.N1.G1.B512.%j.out 
#SBATCH --error=logs/tensorflow_cifar10_resnet.N1.G1.B512.%j.err 
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --nodes=1 
...
srun -l python train.tensorflow.py --config=configs/tensorflow_cifar10_resnet.B512.yaml 
