...
#SBATCH --output=logs/tensorflow_imagenet_resnet.N1.G1.B128.%j.out 
#SBATCH --error=logs/tensorflow_imagenet_resnet.N1.G1.B128.%j.err 
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --nodes=1
...
do
    ...
    srun -w $node -n 1 -l --export=ALL,TF_CONFIG python train.tensorflow.distributed.py --config=configs/tensorflow_imagenet_resnet.B128.yaml & 
    INDEX=$(($INDEX+1))
done
