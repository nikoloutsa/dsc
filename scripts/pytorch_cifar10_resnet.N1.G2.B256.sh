...
srun -l python -u train.pytorch.cifar10.py --config=configs/pytorch_cifar10_resnet.B256.yaml --dist-url "tcp://${NODES[0]}-ib:5555" --dist-backend 'nccl' --multiprocessing-distributed --world-size $NUM_NODES --rank 0
