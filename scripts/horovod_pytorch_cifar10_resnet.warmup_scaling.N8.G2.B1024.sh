...
#SBATCH --output=logs/horovod_pytorch_cifar10_resnet.warmup_scaling.N8.G2.B1024.%j.out 
#SBATCH --error=logs/horovod_pytorch_cifar10_resnet.warmup_scaling.N8.G2.B1024.%j.err 
#SBATCH --ntasks=16
#SBATCH --gres=gpu:2
#SBATCH --nodes=8 
...
srun -l python -u train.horovod.pytorch.cifar10.py --config=configs/pytorch_cifar10_resnet.B1024.E90.yaml --warmup-epochs=5
