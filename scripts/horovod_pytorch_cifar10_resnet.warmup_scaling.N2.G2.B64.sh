...
#SBATCH --output=logs/horovod_pytorch_cifar10_resnet.warmup_scaling.N2.G2.B64.%j.out 
#SBATCH --error=logs/horovod_pytorch_cifar10_resnet.warmup_scaling.N2.G2.B64.%j.err 
#SBATCH --ntasks=4
#SBATCH --gres=gpu:2
#SBATCH --nodes=2 
