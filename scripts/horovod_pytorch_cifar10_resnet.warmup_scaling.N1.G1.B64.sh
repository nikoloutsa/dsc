...
#SBATCH --output=logs/horovod_pytorch_cifar10_resnet.warmup_scaling.N1.G1.B64.%j.out 
#SBATCH --error=logs/horovod_pytorch_cifar10_resnet.warmup_scaling.N1.G1.B64.%j.err 
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --nodes=1 
