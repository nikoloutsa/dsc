...
#SBATCH --output=logs/pytorch_imagenet_resnet.N1.G1.B96.%j.out 
#SBATCH --error=logs/pytorch_imagenet_resnet.N1.G1.B96.%j.err 
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --nodes=1
...
srun -N 1 -n 1 -l python -u train.pytorch.imagenet.py --config=configs/pytorch_imagenet_resnet.B96.yaml
