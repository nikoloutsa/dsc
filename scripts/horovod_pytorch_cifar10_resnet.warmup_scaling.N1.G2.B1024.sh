...
#SBATCH --output=logs/horovod_pytorch_cifar10_resnet.warmup_scaling.N1.G2.B1024.%j.out 
#SBATCH --error=logs/horovod_pytorch_cifar10_resnet.warmup_scaling.N1.G2.B1024.%j.err 
#SBATCH --ntasks=2
#SBATCH --gres=gpu:2
#SBATCH --nodes=1 
