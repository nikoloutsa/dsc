...
#SBATCH --output=logs/horovod_pytorch_imagenet_resnet.N8.G2.B120.%j.out 
#SBATCH --error=logs/horovod_pytorch_imagenet_resnet.N8.G2.B120.%j.err 
#SBATCH --ntasks=16
#SBATCH --gres=gpu:2
#SBATCH --nodes=8
...
srun -l python train.horovod.pytorch.imagenet.py --config=configs/pytorch_imagenet_resnet.B120.yaml
