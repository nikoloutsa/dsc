...
#SBATCH --output=logs/horovod_pytorch_cifar10_resnet.warmup_scaling.N8.G2.B128.%j.out 
#SBATCH --error=logs/horovod_pytorch_cifar10_resnet.warmup_scaling.N8.G2.B128.%j.err 
#SBATCH --ntasks=16
#SBATCH --gres=gpu:2
#SBATCH --nodes=8 
