...
#SBATCH --output=logs/tensorflow_imagenet_resnet.N8.G2.B16.%j.out 
#SBATCH --error=logs/tensorflow_imagenet_resnet.N8.G2.B16.%j.err 
#SBATCH --ntasks=8
#SBATCH --gres=gpu:2
#SBATCH --nodes=8
...
do
    ...
    srun -w $node -n 1 -l --export=ALL,TF_CONFIG python train.tensorflow.distributed.py --config=configs/tensorflow_imagenet_resnet.B16.yaml & 
    INDEX=$(($INDEX+1))
done
