...
#SBATCH --output=logs/horovod_pytorch_cifar10_resnet.naive.N1.G2.B1024.%j.out 
#SBATCH --error=logs/horovod_pytorch_cifar10_resnet.naive.N1.G2.B1024.%j.err 
#SBATCH --ntasks=2
#SBATCH --gres=gpu:2
#SBATCH --nodes=1 
...
srun -l python -u train.horovod.pytorch.cifar10.naive.py --config=configs/pytorch_cifar10_resnet.B1024.E90.yaml 
