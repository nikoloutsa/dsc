...
#SBATCH --output=logs/horovod_pytorch_cifar10_resnet.warmup_scaling.N16.G2.B64.%j.out 
#SBATCH --error=logs/horovod_pytorch_cifar10_resnet.warmup_scaling.N16.G2.B64.%j.err 
#SBATCH --ntasks=32
#SBATCH --gres=gpu:2
#SBATCH --nodes=16 
...
srun -l python -u train.horovod.pytorch.cifar10.py --config=configs/pytorch_cifar10_resnet.B64.E90.yaml --warmup-epochs=5
