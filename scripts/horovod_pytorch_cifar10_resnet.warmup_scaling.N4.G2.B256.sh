...
#SBATCH --output=logs/horovod_pytorch_cifar10_resnet.warmup_scaling.N4.G2.B256.%j.out 
#SBATCH --error=logs/horovod_pytorch_cifar10_resnet.warmup_scaling.N4.G2.B256.%j.err 
#SBATCH --ntasks=8
#SBATCH --gres=gpu:2
#SBATCH --nodes=4 
