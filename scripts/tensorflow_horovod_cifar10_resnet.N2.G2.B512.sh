...
#SBATCH --job-name=tensorflow_horovod_cifar10_resnet 
#SBATCH --output=logs/tensorflow_horovod_cifar10_resnet.N2.G2.B512.%j.out 
#SBATCH --error=logs/tensorflow_horovod_cifar10_resnet.N2.G2.B512.%j.err 
#SBATCH --ntasks=4
#SBATCH --gres=gpu:2
#SBATCH --nodes=2
...
srun -l python train.tensorflow.horovod.py --config=configs/tensorflow_cifar10_resnet.B512.yaml
