...
#SBATCH --output=logs/tensorflow_cifar10_resnet.N1.G2.B32.%j.out 
#SBATCH --error=logs/tensorflow_cifar10_resnet.N1.G2.B32.%j.err 
#SBATCH --ntasks=1
#SBATCH --gres=gpu:2
#SBATCH --nodes=1 
...
srun -l python train.tensorflow.py --config=configs/tensorflow_cifar10_resnet.B32.yaml --mirrored
