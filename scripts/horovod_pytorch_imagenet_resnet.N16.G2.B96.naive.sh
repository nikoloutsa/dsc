...
#SBATCH --output=logs/horovod_pytorch_imagenet_resnet.N16.G2.B96.%j.out 
#SBATCH --error=logs/horovod_pytorch_imagenet_resnet.N16.G2.B96.%j.err 
#SBATCH --ntasks=32
#SBATCH --gres=gpu:2
#SBATCH --nodes=16
...
srun -l python train.horovod.pytorch.imagenet.naive.py --config=configs/pytorch_imagenet_resnet.B96.E60.yaml --warmup-epochs=0
