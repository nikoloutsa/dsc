...
#SBATCH --output=logs/pytorch_cifar10_resnet.N1.G1.B512.%j.out 
#SBATCH --error=logs/pytorch_cifar10_resnet.N1.G1.B512.%j.err 
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --nodes=1 
...
srun -l python train.pytorch.cifar10.py --config=configs/pytorch_cifar10_resnet.B512.yaml 
