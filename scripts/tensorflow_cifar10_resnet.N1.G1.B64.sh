...
#SBATCH --output=logs/tensorflow_cifar10_resnet.N1.G1.B64.%j.out 
#SBATCH --error=logs/tensorflow_cifar10_resnet.N1.G1.B64.%j.err 
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --nodes=1 
...
#SBATCH -t 07:00:00 # Run time (hh:mm:ss) - (max 48h)
...
srun -l python train.tensorflow.py configs/tensorflow_cifar10_resnet.B64.yaml 
