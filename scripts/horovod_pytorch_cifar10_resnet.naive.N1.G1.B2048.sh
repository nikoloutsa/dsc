...
#SBATCH --output=logs/horovod_pytorch_cifar10_resnet.naive.N1.G1.B2048.%j.out 
#SBATCH --error=logs/horovod_pytorch_cifar10_resnet.naive.N1.G1.B2048.%j.err 
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --nodes=1 
...
srun -l python -u train.horovod.pytorch.cifar10.naive.py --config=configs/pytorch_cifar10_resnet.B2048.E90.yaml 
