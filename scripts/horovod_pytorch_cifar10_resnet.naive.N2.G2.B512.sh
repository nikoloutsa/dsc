...
#SBATCH --output=logs/horovod_pytorch_cifar10_resnet.naive.N2.G2.B512.%j.out 
#SBATCH --error=logs/horovod_pytorch_cifar10_resnet.naive.N2.G2.B512.%j.err 
#SBATCH --ntasks=4
#SBATCH --gres=gpu:2
#SBATCH --nodes=2 
...
srun -l python -u train.horovod.pytorch.cifar10.naive.py --config=configs/pytorch_cifar10_resnet.B512.E90.yaml 
