...
#SBATCH --output=logs/horovod_pytorch_cifar10_resnet.naive.N8.G2.B128.%j.out 
#SBATCH --error=logs/horovod_pytorch_cifar10_resnet.naive.N8.G2.B128.%j.err 
#SBATCH --ntasks=16
#SBATCH --gres=gpu:2
#SBATCH --nodes=8 
...
srun -l python -u train.horovod.pytorch.cifar10.naive.py --config=configs/pytorch_cifar10_resnet.B128.E90.yaml 
