...
#SBATCH --output=logs/horovod_tensorflow_cifar10_resnet.N1.G1.B64.%j.out 
#SBATCH --error=logs/horovod_tensorflow_cifar10_resnet.N1.G1.B64.%j.err 
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --nodes=1 
...
srun -l python train.horovod.tensorflow.py --config=configs/tensorflow_cifar10_resnet.B64.yaml
