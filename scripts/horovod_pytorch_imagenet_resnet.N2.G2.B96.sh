...
#SBATCH --output=logs/horovod_pytorch_imagenet_resnet.N2.G2.B96.%j.out 
#SBATCH --error=logs/horovod_pytorch_imagenet_resnet.N2.G2.B96.%j.err 
#SBATCH --ntasks=4
#SBATCH --gres=gpu:2
#SBATCH --nodes=2
...
srun -l python -u train.horovod.pytorch.imagenet.py --config=configs/pytorch_imagenet_resnet.B96.yaml
