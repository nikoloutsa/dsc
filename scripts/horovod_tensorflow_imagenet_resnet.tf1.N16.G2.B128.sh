...
#SBATCH --output=logs/horovod_tensorflow_imagenet_resnet.tf1.N16.G2.B128.%j.out 
#SBATCH --error=logs/horovod_tensorflow_imagenet_resnet.tf1.N16.G2.B128.%j.err 
#SBATCH --ntasks=32
#SBATCH --gres=gpu:2
#SBATCH --nodes=16
...
srun -l python -u train.horovod.tensorflow.tf1.py --config=configs/tensorflow_imagenet_resnet.B128.yaml
