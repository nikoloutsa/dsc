...
#SBATCH --output=logs/horovod_pytorch_cifar10_resnet.warmup_scaling.N2.G2.B256.%j.out 
#SBATCH --error=logs/horovod_pytorch_cifar10_resnet.warmup_scaling.N2.G2.B256.%j.err 
#SBATCH --ntasks=4
#SBATCH --gres=gpu:2
#SBATCH --nodes=2 
...
srun -l python -u train.horovod.pytorch.cifar10.py --config=configs/pytorch_cifar10_resnet.B256.E90.yaml --warmup-epochs=5
