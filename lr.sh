...
#SBATCH --job-name=lr 
#SBATCH --output=logs/lr.scaling.N1.G2.B64.%j.out 
#SBATCH --error=logs/lr.scaling.N1.G2.B64.%j.err 
#SBATCH --ntasks=2
#SBATCH --gres=gpu:2
#SBATCH --nodes=1 
...
srun -l python -u lr.py --config=configs/pytorch_cifar10_resnet.B64.E90.yaml --warmup-epochs=0
