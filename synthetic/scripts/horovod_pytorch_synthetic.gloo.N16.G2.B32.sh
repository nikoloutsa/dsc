...
#SBATCH --output=logs/horovod_pytorch_synthetic_benchmark.gloo.N16.G2.B32.%j.out 
#SBATCH --error=logs/horovod_pytorch_synthetic_benchmark.gloo.N16.G2.B32.%j.err 
#SBATCH --ntasks=32
#SBATCH --gres=gpu:2
#SBATCH --nodes=16
