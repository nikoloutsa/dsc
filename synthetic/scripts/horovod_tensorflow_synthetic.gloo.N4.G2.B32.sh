...
#SBATCH --output=logs/horovod_tensorflow_synthetic_benchmark.gloo.N4.G2.B32.%j.out 
#SBATCH --error=logs/horovod_tensorflow_synthetic_benchmark.gloo.N4.G2.B32.%j.err 
#SBATCH --ntasks=8
#SBATCH --gres=gpu:2
#SBATCH --nodes=4
