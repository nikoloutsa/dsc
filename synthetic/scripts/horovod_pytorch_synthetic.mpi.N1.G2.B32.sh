...
#SBATCH --output=logs/horovod_pytorch_synthetic_benchmark.mpi.N1.G2.B32.%j.out 
#SBATCH --error=logs/horovod_pytorch_synthetic_benchmark.mpi.N1.G2.B32.%j.err 
#SBATCH --ntasks=2
#SBATCH --gres=gpu:2
#SBATCH --nodes=1
...
#horovodrun --mpi -np $SLURM_NTASKS -H $WORKERS --start-timeout 120  \
