...
#SBATCH --error=logs/horovod_pytorch_synthetic_benchmark.N1.G1.B32.%j.err 
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --nodes=1
...
srun -l python -u train.horovod.pytorch.synthetic.py --batch-size 32 --num-batches-per-iter ${1:-128} --num-iters 1
