...
#SBATCH --output=logs/horovod_tensorflow_synthetic_benchmark.gloo.N1.G1.B32.%j.out 
#SBATCH --error=logs/horovod_tensorflow_synthetic_benchmark.gloo.N1.G1.B32.%j.err 
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --nodes=1
