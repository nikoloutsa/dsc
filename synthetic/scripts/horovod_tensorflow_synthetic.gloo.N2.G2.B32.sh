...
#SBATCH --output=logs/horovod_tensorflow_synthetic_benchmark.gloo.N2.G2.B32.%j.out 
#SBATCH --error=logs/horovod_tensorflow_synthetic_benchmark.gloo.N2.G2.B32.%j.err 
#SBATCH --ntasks=4
#SBATCH --gres=gpu:2
#SBATCH --nodes=2
