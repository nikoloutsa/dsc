...
if args.cuda:
    ...
    for gpu in gpus:
        ...
        #    [tf.config.LogicalDeviceConfiguration(memory_limit=8000)]) #11520
    if gpus:
...
if verbose:
    ...
    print('Average time per epoch: {:.3f} s'.format(timing.img_sec_mean))
    print('Total time: {:.3f} s'.format(hvd.size() * timing.img_sec_mean))
